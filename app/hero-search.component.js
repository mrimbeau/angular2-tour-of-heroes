...
var HeroSearchComponent = (function () {
    function HeroSearchComponent(heroSearchService, router) {
        ...
        this.router = router;
        this.searchTerms = new Subject_1.Subject(); // = Observable
    }
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        this.heroes = this.searchTerms
            ...
            .switchMap(function (term) { return term // switch to new observable each time, It cancels and discards previous search observables, returning only the latest (most recent) search service observable.
